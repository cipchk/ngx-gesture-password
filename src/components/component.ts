import { Component, ElementRef, ViewEncapsulation, Input, Renderer, OnChanges, SimpleChanges, OnDestroy, Output, EventEmitter, forwardRef } from '@angular/core';
...
export class GesturePasswordComponent implements OnChanges, OnDestroy, ControlValueAccessor {
    ...
    async recorder() {
        // 第一次
        this.rc.clearPath();
        let first = await this.rc.record();
        ...
        // 第二次
        this.rc.clearPath();
        let second = await this.rc.record();
    ...
    render() {
        ...
        this.renderer.setElementStyle(this.el.nativeElement, 'backgroundColor', opt.bgColor);
